...
namespace Engine
{
	...
	public:
		...
		static void BeginScene(const std::shared_ptr<Camera>& camera = nullptr, const std::shared_ptr<Texture2DArray> teture = nullptr, const std::shared_ptr<Shader> shader = nullptr);
